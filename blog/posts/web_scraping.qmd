...
2. Extract the views, answers and the votes
...
3. We can choose to save it to excel format, produce plots or pivot_tables.
...
### Scraping Stack Overflow Questions with scrapy
